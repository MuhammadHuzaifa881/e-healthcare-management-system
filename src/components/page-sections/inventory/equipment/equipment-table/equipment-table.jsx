  ...
  const MaintenanceStatus = ({ last, next }) => {
    ...
    return (
      <div className="flex items-center gap-2">
        <FiCalendar className="text-gray-500 h-4 w-4" />
        <span className={daysUntil <= 30 ? "text-yellow-600 font-medium" : ""}>
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem onClick={() => setStatusFilter("needs_repair")}>
                Needs Repair
              </DropdownMenuItem>
              <DropdownMenuItem
            ...
            {currentEquipment.length > 0 ? (
              currentEquipment.map((item) => {
                ...
                const warrantyExpiring =
                  warrantyDate - today < 180 * 24 * 60 * 60 * 1000;
