...
const PatientList = ({
  ...
  setActiveTab,
  patientCounts,
  setEditDetail,setPatientModalOpen
}) => {
          ...
          <CardContent>
            ...
            >
              <TabsList className="grid grid-cols-4 mb-4">
                <TabsTrigger value="all">All ({patientCounts.all})</TabsTrigger>
                      ...
                      <TableRow key={patient.id}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            <Button variant="outline" size="sm" className="h-8" onClick={()=>handleEdit(patient)}>
